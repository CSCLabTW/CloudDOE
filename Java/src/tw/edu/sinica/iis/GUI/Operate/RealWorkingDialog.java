...
public class RealWorkingDialog extends JDialog implements Runnable {

	private static final long serialVersionUID = -3796282198666503606L;
	...
	public RealWorkingDialog(JFrame f, boolean b, String s) {
		super(f, b);
		Content = s;
		Count = 0;
		this.setSize(200, 40);
	...
	public static void main(String[] args) {
		...
		b.addActionListener(new ActionListener() {
			public RealWorkingDialog tmp;

			@Override
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				tmp = new RealWorkingDialog(null, true, "testing");
